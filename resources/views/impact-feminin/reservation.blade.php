...
@section('title', 'Réservation Impact Féminin - Excellence Afrik')
@section('meta_description', 'Réservez votre place pour Impact Féminin 2025, l\'événement qui célèbre l\'excellence entrepreneuriale féminine.')
        ...
        <div class="row">
            <div class="col-12 text-center mb-5">
                <h1 class="impact-main-title" data-aos="fade-up" data-aos-duration="1000">
                    Réservation Impact Féminin 2025
                </h1>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="form-section shadow-sm">
                    ...
                    <form action="{{ route('impact-feminin.reservation.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="type_reservation" name="type_reservation" required>
                                ...
                                <option value="participant" {{ old('type_reservation') == 'participant' ? 'selected' : '' }}>Participant</option>
                                <option value="sponsor" {{ old('type_reservation') == 'sponsor' ? 'selected' : '' }}>Sponsor</option>
                                <option value="exposant" {{ old('type_reservation') == 'exposant' ? 'selected' : '' }}>Exposant</option>
                            </select>
                        </div>

                        <div class="text-center mt-4">
                            <button type="submit" class="submit-btn">Confirmer ma réservation</button>
                        </div>
